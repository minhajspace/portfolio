                ...
                <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                    <div id="profile" className={`w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl  opacity-75 mx-6 lg:mx-0 ${dark ? `bg-color-dark` : `bg-white`}`}>
                        <div className="p-4 md:p-12 text-center lg:text-left">
                            ...
                            <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center profile"></div>
                            <h1 className="text-3xl font-bold pt-8 lg:pt-0">Minhaj Ahmad khan</h1>
...
I also write about the web on my Blog and on Twitter.  </p>
                    ...
                    <div className="w-full lg:w-2/5 ">
                        <img src="https://scontent.fdel12-1.fna.fbcdn.net/v/t1.0-9/98366424_3155307257863705_7454899732100415488_o.jpg?_nc_cat=105&ccb=2&_nc_sid=84a396&_nc_ohc=4W4Mgt1W_OYAX85Zxup&_nc_ht=scontent.fdel12-1.fna&oh=671e613ced8fdf0fac52c6e48b20b9e5&oe=6035B80D" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"></img>
                    </div>
                    <div className="absolute top-0 right-0 h-12 w-18 p-4">
                        <button onClick={activeDarkMode} className="js-change-theme focus:outline-none"> {dark ? '☀️' : '🌙'}</button>
                    </div>
                </div>
